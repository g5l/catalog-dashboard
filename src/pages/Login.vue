      ...
      <form novalidate class="md-layout" @submit.prevent="validateUser">
        <md-field :class="getValidationClass('email')">
          ...
          <md-input
            ...
            autofocus
          />
          <span v-if="!$v.login.email.required" class="md-error">
            É preciso informar um e-mail
          </span>
          <span v-if="!$v.login.email.email" class="md-error">
            e-mail inválido
          </span>
        </md-field>
        ...
        <md-field :class="getValidationClass('password')" md-has-password>
          ...
          <md-input
            ...
            name="password"
          />
          <span v-if="!$v.login.password.required" class="md-error">
            É preciso informar uma senha
          </span>
        </md-field>

        <div
          class="actions md-layout"
